...
Public Class MAJORREPORT
    ...
    Private Sub MAJORREPORT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        mypopulate("select * from bim0kocn6y1cl68dqubs.report", DataGridView1)
    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        OpenChildForm(New REPORTADD)
        Me.Close()
    End Sub
    ...
    Private Sub BunifuMaterialTextbox1_OnValueChanged(sender As Object, e As EventArgs) Handles BunifuMaterialTextbox1.OnValueChanged
        If ComboBox1.Text = "" Then
            mypopulate("Select * from bim0kocn6y1cl68dqubs.report where " & "AdminInCharge" & " LIKE '%" & BunifuMaterialTextbox1.Text & "%'", DataGridView1)
        Else
            mypopulate("Select * from bim0kocn6y1cl68dqubs.report where " & ComboBox1.Text & " LIKE '%" & BunifuMaterialTextbox1.Text & "%'", DataGridView1)
        End If
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        nonquery("delete from bim0kocn6y1cl68dqubs.report where ReportID = '" & ReportID & "'")
        mypopulate("select * from bim0kocn6y1cl68dqubs.report", DataGridView1)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        TechList.ReportID = DataGridView1.Item(0, DataGridView1.CurrentRow.Index).Value
        TechList.RepU = DataGridView1.Item(1, DataGridView1.CurrentRow.Index).Value
        TechList.Tools = DataGridView1.Item(2, DataGridView1.CurrentRow.Index).Value
        TechList.Casualty = DataGridView1.Item(3, DataGridView1.CurrentRow.Index).Value
        TechList.InCharge = DataGridView1.Item(5, DataGridView1.CurrentRow.Index).Value
        TechList.RepS = DataGridView1.Item(6, DataGridView1.CurrentRow.Index).Value

        OpenChildForm(New REPORTUPDATE)
        Me.Close()
    End Sub
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        ...
        TechList.StubProf = DataGridView1.Item(5, DataGridView1.CurrentRow.Index).Value
        ...
        TechList.StubStatus = DataGridView1.Item(6, DataGridView1.CurrentRow.Index).Value
