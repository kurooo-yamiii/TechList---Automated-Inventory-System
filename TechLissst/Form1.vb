...
Public Class Form1
    ...
    Private Sub BunifuImageButton1_Click(sender As Object, e As EventArgs) Handles BunifuImageButton1.Click
        ...
        If TechList.ActivityAdmin = "*" Then
            Me.Close()
            LOGIN.Show()
        Else
            nonquery("insert into bim0kocn6y1cl68dqubs.log values('" & Label3.Text & "','" & TechList.ToDate & "','" & TechList.ActivityAdmin & "','" & TechList.InTime & "','" & Label1.Text & "','" & Label2.Text & "')")
            bnonquery("insert into btuuxshmsyyx30v5w9ii.log values('" & Label3.Text & "','" & TechList.ToDate & "','" & TechList.ActivityAdmin & "','" & TechList.InTime & "','" & Label1.Text & "','" & Label2.Text & "')")
            TechList.ActivityAdmin = "*"
            Me.Close()
            LOGIN.Show()
        End If
    End Sub
    ...
    Private Sub BunifuFlatButton10_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton10.Click
        OpenChildForm(New PROJECTORLOG)
        HIDESUB()
        HOME.Close()
    End Sub
