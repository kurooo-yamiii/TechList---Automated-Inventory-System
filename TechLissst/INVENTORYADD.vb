Public Class INVENTORYADD
    ...
    Private Sub Button4_Click_1(sender As Object, e As EventArgs) Handles Button4.Click
        Dim ItemID As String = selectspecific("select ItemID from bim0kocn6y1cl68dqubs.part")
        Label1.Text = Val(ItemID) + 1
        TechList.ActivityAdmin = TechList.ActivityAdmin & "Added Item, "
        nonquery("insert into bim0kocn6y1cl68dqubs.part values('" & Label1.Text & "','" & BunifuMaterialTextbox1.Text & "','" & BunifuMaterialTextbox2.Text & "','" & Label2.Text & "','" & Label2.Text & "','" & ComboBox1.Text & "')")
        bnonquery("insert into btuuxshmsyyx30v5w9ii.part values('" & Label1.Text & "','" & BunifuMaterialTextbox1.Text & "','" & BunifuMaterialTextbox2.Text & "','" & Label2.Text & "','" & Label2.Text & "','" & ComboBox1.Text & "')")
        MsgBox("PC is Successfuly ADDED", MsgBoxStyle.Information, "TechList - Automated Inventory System")
