...
Public Class MINORREPORTSTUB
    ...
    Private Sub MAJORREPORTSTUB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If TechList.MStubID < 10 Then
            BunifuCustomLabel1.Text = 0 & TechList.MStubID
            Label7.Text = TechList.MStubProf
            Label4.Text = TechList.StubProblem
            Label9.Text = TechList.MStubDate
            Label10.Text = TechList.StubSearched
        Else
            BunifuCustomLabel1.Text = TechList.MStubID
            Label7.Text = TechList.MStubProf
            Label4.Text = TechList.StubProblem
            Label9.Text = TechList.MStubDate
            Label10.Text = TechList.StubSearched
